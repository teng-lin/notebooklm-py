...
def test_only_rpc_and_network_shaped_reasons_are_swallowed_by_the_rename() -> None:
    ...
    """
    from notebooklm._source_service import _RENAME_SWALLOWED_REASONS
    ...
    for reason in _RENAME_SWALLOWED_REASONS:
    ...
    assert BackendErrorReason.SOURCE_ADD not in _RENAME_SWALLOWED_REASONS
