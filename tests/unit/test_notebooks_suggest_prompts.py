...
@pytest.fixture
def api(mock_rpc: MagicMock) -> WebNotebooksAPI:
...
class TestSuggestPrompts:
    ...
    async def test_decodes_rows_to_prompt_suggestions(
        self, api: WebNotebooksAPI, mock_rpc: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_sends_expected_rpc(self, api: WebNotebooksAPI, mock_rpc: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_explicit_source_ids_skip_resolution(self, api: WebNotebooksAPI) -> None:
    ...
    async def test_out_of_range_mode_raises_before_any_network(
        self, api: WebNotebooksAPI, mock_rpc: MagicMock, mode: int
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_single_suggestion_wrapped(
        self, api: WebNotebooksAPI, mock_rpc: MagicMock
    ) -> None:
    ...
    async def test_degenerate_payloads_yield_empty(
        self, api: WebNotebooksAPI, mock_rpc: MagicMock, payload: object
    ) -> None:
