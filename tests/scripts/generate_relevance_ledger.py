...
NODE_OVERRIDE_RULES: dict[str, dict[str, object]] = {
    ...
    "test_no_cli_client_patch_surface.py": {
        ...
        "oracle": "AST symbol inspection of Click command module bodies",
        "rationale": "Client injection refactoring complete; Click client isolation verified by runtime CLI tests",
        "review_condition": "historical_reference_only",
        "runtime_cost": "ast_scan",
    },
