...
async def test_waiter_cancellation_does_not_kill_shared_refresh():
    ...
    async with _opened_core(refresh_callback=cb) as core:
        ...
        assert core._provider._coordinator._refresh_task is not None, "shared refresh task vanished"
        assert not core._provider._coordinator._refresh_task.done(), (
...
async def test_refresh_task_slot_not_cleared_on_waiter_cancellation():
    ...
    async with _opened_core(refresh_callback=cb) as core:
        ...
        in_flight = core._provider._coordinator._refresh_task
        ...
        assert core._provider._coordinator._refresh_task is in_flight, (
