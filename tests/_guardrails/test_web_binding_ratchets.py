...
#: handlers from the P9.2 stop/go baseline. P10 R3.2-R3.5 then took the four
#: probed source-add rows above the port, 20 -> 16; the ratchet asserts
#: equality, so a hoist that does not tighten it leaves this gate red.
RESIDUAL_COMPOSITE_CEILING = 16
#: Exact custom-row counts per justification category: ``SOURCE_ADD_FILE``,
#: ``CHAT_ASK``, the Studio
...
#: second backend.
CUSTOM_ROW_COUNTS = {"protocol": 2, "compatibility": 3, "deferred-product": 11}
