...
STRING_PATCH_CEILINGS: dict[str, int] = {
    ...
    "tests/unit/cli/test_helpers.py": 66,
    ...
    "tests/unit/cli/test_playwright_login_render_contract.py": 14,
