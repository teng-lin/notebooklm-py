...
WORKFLOW_SCOPE_CALL_INVENTORY = (
    *_call_rows(
        ...
        (
            ...
            ("src/notebooklm/_artifacts.py", "ArtifactsAPI._download_per_kind", 1),
            ("src/notebooklm/_sources.py", "SourcesAPI.delete_many_with_outcomes", 1),
    ...
    *_call_rows(
        ...
        (
            ...
            ("src/notebooklm/_web/artifacts.py", "WebArtifactsAPI._download_audio_legacy", 1),
            ("src/notebooklm/_web/artifacts.py", "WebArtifactsAPI._download_data_table_legacy", 1),
            ("src/notebooklm/_web/artifacts.py", "WebArtifactsAPI._download_flashcards_legacy", 1),
            ("src/notebooklm/_web/artifacts.py", "WebArtifactsAPI._download_infographic_legacy", 1),
            ("src/notebooklm/_web/artifacts.py", "WebArtifactsAPI._download_mind_map_legacy", 1),
            ("src/notebooklm/_web/artifacts.py", "WebArtifactsAPI._download_quiz_legacy", 1),
            ("src/notebooklm/_web/artifacts.py", "WebArtifactsAPI._download_report_legacy", 1),
            ("src/notebooklm/_web/artifacts.py", "WebArtifactsAPI._download_slide_deck_legacy", 1),
            ("src/notebooklm/_web/artifacts.py", "WebArtifactsAPI._download_video_legacy", 1),
            ("src/notebooklm/_web/artifacts.py", "WebArtifactsAPI.list_with_status", 1),
            ("src/notebooklm/_web/artifacts.py", "WebArtifactsAPI.prepare_downloads", 1),
            ("src/notebooklm/_web/artifacts.py", "WebArtifactsAPI.download", 1),
            ("src/notebooklm/_android/artifacts.py", "AndroidArtifactsAPI.prepare_downloads", 1),
            ("src/notebooklm/_android/artifacts.py", "AndroidArtifactsAPI.download", 1),
...
REQUIRED_WORKFLOW_ENTRYPOINT_INVENTORY = (
    ...
    *(
        SymbolInventory(
            "src/notebooklm/_web/artifacts.py",
            f"WebArtifactsAPI._{method}_legacy",
