...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in labs/language/tailwind/sharing/sharing_pb2_grpc.py depends on'
...
class LabsTailwindSharingServiceStub(object):
...
def add_LabsTailwindSharingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'labs.language.tailwind.sharing.LabsTailwindSharingService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('labs.language.tailwind.sharing.LabsTailwindSharingService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class LabsTailwindSharingService(object):
    """Missing associated documentation comment in .proto file."""
