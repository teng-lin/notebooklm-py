...
Pure HTML/JSON presentation for the interactive (quiz/flashcard) families.
The positional ``LIST_ARTIFACTS`` data-table decoders that used to live here
are wire-shaped and moved below the semantic port to
``_web/codec/artifact_formatters.py`` (P10 invariant I2), which is why this
module names no RPC method and imports nothing from ``rpc``.
"""
