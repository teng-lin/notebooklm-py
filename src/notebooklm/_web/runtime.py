"""Backend-owned execution runtime for NotebookLM web RPC operations.
...
__all__ = ["DecodeResponse", "WebExecutionRuntime"]
...
# Preserve the historical logger namespace after moving execution ownership.
...
if TYPE_CHECKING:
    ...
    def _assert_web_runtime_satisfies_rpc_caller(executor: WebExecutionRuntime) -> None:
