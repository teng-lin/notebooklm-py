"""Sharing codec rows (P9.3 sharing domain).
...
``SHARING_SET_VIEW_LEVEL``, ``SHARING_UPDATE_USERS``) stay handlers in
``_web/sharing.py`` until their P9.2 hoist.
"""
...
from ..._records import LEGACY_SHARE_ARTIFACT_DEF, SHARING_GET_DEF
...
__all__ = ["LEGACY_SHARE_ARTIFACT", "SHARING_GET", "SHARING_ROWS"]
