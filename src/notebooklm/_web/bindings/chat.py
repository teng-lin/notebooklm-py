...
notebook read, the mutation branch the settings replacement.  ``CHAT_ASK`` stays
a handler — its streamed phase followed by a conditional conversation-id read is
a protocol-forced sequence (gate table §3.16) and becomes a custom row in P9.4.
"""
