"""Legacy package marker for NotebookLM collections (account-level notebook groups).
...
with three wire differences captured in :mod:`notebooklm._web.params.collections`.
"""
