...
| [`schema.proto`](schema.proto) | `11c4b8cd4c26d9ac4c08db217c13c1b4c92089a1efc47dec79883bc11b8084bc` | flattened Dart recovery used to identify gaps, never as a compile input; retains 15 zero-field messages and exact per-message package/library provenance |
| [`enums.txt`](enums.txt) | `873bb08e31617e61f5b2f40ab5e0d9b87a0e07961845dccbd91c85e61c457ab3` | exhaustive enum names and integers |
...
| [`endpoints.md`](endpoints.md) | `adb89335c71c435387efdb92a5d4c8410be57949115c2a6898c33d9978b127fe` | live request/response envelopes, route results, version-scoped APK inventories, captured note/sharing bytes, and the account-bootstrap replay boundary |
