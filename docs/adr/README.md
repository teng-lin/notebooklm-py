...
| [0002](0002-capability-protocol-pattern.md) | Capability Protocol pattern (`SessionCapabilities` fat union) | Accepted (Sunset = D2 cutover — to be marked Superseded when `arch-d2-cutover` PR lands) |
...
| [0010](0010-session-kernel-split.md) | Session/Kernel split | Superseded by ADR-013 (#<this PR number>) |
