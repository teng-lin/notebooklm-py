...
| `_source/add.py` | The source-add family's best-effort post-create rename (#1960), all that is left after P10 R3.2–R3.5 hoisted the text/URL/Drive/batch workflows: reached only by the permanent `SOURCE_ADD_FILE` row |
