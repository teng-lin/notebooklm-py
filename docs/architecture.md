...
| `_web/registry.py` | Closed web disposition registry over all 98 operations: 77 directly supported (derived from the row table), sixteen service-owned, and five explicitly unsupported. |
