...
and the aggregate 534-node / 1,259-edge transitive-helper graph digest. Adapter
...
# 16 explicit helper fingerprints, and a 534-node / 1,259-edge helper-graph digest.
uv run python - <<'PY'
import json
