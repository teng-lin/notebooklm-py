...
and the aggregate 533-node / 1,258-edge transitive-helper graph digest. Adapter
...
# 16 explicit helper fingerprints, and a 533-node / 1,258-edge helper-graph digest.
uv run python - <<'PY'
import json
