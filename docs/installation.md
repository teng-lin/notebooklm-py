...
For detailed deployment instructions, including FastAPI lifespan management, concurrency, and Docker configuration, see [Production Deployment in the Python API Docs](python-api.md#production-deployment).
