...
- **Mutation envelope.** Synchronous create/rename/update/delete tools return a top-level
  ...
  `removed`, `added`, `imported`, `already_imported`, `cancel_requested`, `cancelled`, `configured` (plus the
